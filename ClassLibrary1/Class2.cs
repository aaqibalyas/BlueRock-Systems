...
namespace Test
{
    public interface IWordFrequencyAnalyzer
    {
        ...
        /// <summary>
        /// How often the does a certain word appear in a string
        /// </summary>
        /// <param name="text">The string you are testing against</param>
        ...
        /// <summary>
        /// The most frequent words, return amount defined by the parameter 
        /// </summary>
        ...
        /// <returns>A list of the implementation of IWordFrequency interfce of the top most common words</returns>
